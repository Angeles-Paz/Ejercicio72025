        ...
        while (flag) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    ejecutable = org.Torres.vista.Consola.getInstance();
                    break;
                case 5:
                    ejecutable = org.Torres.vista.Ventana.getInstance();
                    break;
                case 6:
                    ejecutable = org.Angeles.vista.Consola.getInstance();
                    break;
                case 7:
                    ejecutable = org.Angeles.vista.Ventana.getInstance();
                    break;
                case 8:
                    flag = false;
                    break;
